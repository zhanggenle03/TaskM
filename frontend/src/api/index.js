...
export const getSalaryConfigTemplates = () => http.get('/salary/config/templates')
export const createSalaryConfigTemplate = (data) => http.post('/salary/config/templates', data)
export const updateSalaryConfigTemplate = (id, data) => http.put(`/salary/config/templates/${id}`, data)
export const deleteSalaryConfigTemplate = (id) => http.delete(`/salary/config/templates/${id}`)
export const setActiveSalaryConfigTemplate = (templateId) => http.put('/salary/config/active', { template_id: templateId })
...
export const uploadSalarySlip = (id, file) => {
  const fd = new FormData()
  fd.append('file', file)
  return http.post(`/salary/records/${id}/slip`, fd, {
    headers: { 'Content-Type': 'multipart/form-data' }
  })
}
